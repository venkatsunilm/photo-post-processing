...
class FormatOptimizer:
    ...
    def __init__(self):
        ...
        self.preset_mapping = {
            ...
            "portrait_natural": {"raw": "portrait_natural", "jpeg": "portrait_natural"},
            "portrait_subtle": {"raw": "portrait_subtle", "jpeg": "portrait_subtle"},
            "natural_wildlife": {"raw": "natural_wildlife", "jpeg": "natural_wildlife"},
            "landscape": {"raw": "landscape", "jpeg": "landscape"},
        }
    ...
    def recommend_processing_strategy(self, file_paths, preset_name):
        ...
        if format_counts["raw"] > 0 and format_counts["jpeg"] > 0:
            ...
            print("   ⏱️  Expected processing time: ~3x baseline (RAW processing)")
        elif format_counts["jpeg"] > 0:
            print("\n💡 JPEG-ONLY STRATEGY:")
            print(
                f"   🖼️  All files will use: {self.get_optimal_preset('dummy.jpg', preset_name)}"
            )
            print("   ⏱️  Expected processing time: ~1x baseline (fast JPEG processing)")
